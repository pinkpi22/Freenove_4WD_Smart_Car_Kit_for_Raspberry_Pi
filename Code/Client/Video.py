    ...
    def find_bottle(self,img):
        if sys.platform.startswith('win') or sys.platform.startswith('darwin'):
            ...
            for i in range(len(scores)):
                ...
                if ((labels[int(classes[i])] == 'person') and (scores[i] > max_score) and (scores[i] > min_conf_threshold) and (scores[i] <= 1.0)): # We think this controls the face recognition
...
=======
        ...
        #        self.face_y=0
        #cv2.imwrite('video.jpg',img)
>>>>>>> e3ca4594ce399495ebaccae9c1302b5401a0c045
