...
class mywindow(QMainWindow,Ui_Client):
    def __init__(self):
        ...
        self.Boundary.toggled.connect(lambda:self.on_btn_Mode(self.Boundary))
        ...
        self.checkBox_Led_Ball.clicked.connect(self.Tracking_Ball)
    ...
    def LedChange(self,b):
        ...
        if b.text() == "Led_Mode1":
           if b.isChecked() == True:
               ...
               self.checkBox_Led_Mode3.setChecked(False)
               self.checkBox_Led_Mode4.setChecked(False)
               self.checkBox_Led_Ball.setChecked(False)
    ...
    def Tracking_Ball(self):
        if self.checkBox_Led_Ball.text()=="Find Ball":
            self.checkBox_Led_Ball.setText("Stop Looking")
            mediate.button = "Stop Looking"
        else:
            self.checkBox_Led_Ball.setText("Find Ball")
            mediate.button = ""
    ...
    def time(self):
        ...
        try:
            if self.is_valid_jpg('video.jpg'):
                ...
                if self.checkBox_Led_Ball.text()=="Stop Looking":
                        self.LedChange(self.checkBox_Led_Ball)
