...
"")
        ...
        self.Btn_Mode5.setGeometry(QtCore.QRect(230, 420, 90, 30))
    ...
    def retranslateUi(self, Client):
        ...
        self.IP.setText(_translate("Client", "172.20.1.32"))
        ...
        self.Btn_Tracking_Ball.setText(_translate("Client", "Ball-Off"))
